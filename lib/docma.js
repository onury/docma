...
class Docma {
    ...
    _init(config) {
        ...
        const templateConf = _.defaultsDeep(this.config.template, {
            dest: config.dest
        });
        this.template = new DocmaTemplate(templateConf, this.config.app, this.$debug);
        ...
        return fs.ensureDir(jsDest)
            ...
            .then(() => {
                ...
                this.$debug.data(
                    ...
                    utils.getContentSize(script, true), 'KB', '(gzipped)'
                );
