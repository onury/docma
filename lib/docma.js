...
module.exports = (function () {
     ...
     *  @private
     *
     *  @param {String} filePath - Path of the JS file.
     *  @param {Boolean} [noMinify=false] - Whether not to minify the JS content.
     *  @param {Boolean} [checkMinFile=false] - Whether to first check for an
     *  existing minified file (with a `min.js` suffix).
     *
    ...
    /**
     *  Configures the Docma instance the given build configuration.
     *  @private
     *
     ...
     *  @param {Boolean} isApiRoute - Specifies whether this is an API route
     *  which will render JSDoc generated documentation content.
     */
     ...
     *  @param {String} [filePrefix] - File name prefix for the JSON output.
     *
