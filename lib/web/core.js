/* global docma, dust, page, EventEmitter, XMLHttpRequest, sessionStorage */
 ...
 *  @global
 *  @name docma
 *  @emits docma~event:ready
 *  @emits docma~event:render
 *  @emits docma~event:route
 *  @emits docma~event:navigate
 */
(function () {
     ...
     *  {@link ?api=docma-web#docma.Route.Type|`docma.Route.Type`} enumeration
     *  for possible values.
     *  @name docma.Route#type
     *  @type {String}
     *  @instance
     ...
     *  {@link ?api=docma-web#docma.Route.SourceType|`docma.Route.SourceType`} enumeration
     *  for possible values.
     *  @name docma.Route#sourceType
     *  @type {String}
     *  @instance
     ...
     *  @instance
     *
     *  @param {docma.Route} routeInfo - Route to be checked against.
     *  @returns {Boolean}
     */
     ...
     *  @instance
     *
     *  @param {docma.Route} routeInfo - Object to be checked.
     *  @returns {Boolean}
     */
     ...
     *  @emits docma~event:route
     *
     *  @returns {docma.Route} - The route instance for chaining.
     */
    Route.prototype.apply = function () {
        ...
        _trigger(docma.Event.Route, [this.exists() ? this : null]);
        docma.render(this);
        return this;
    };
     ...
     *         enumeration for possible values.
     *
     *  @returns {docma.Route} - Route instance.
     */
    ...
    page('(/)?', function (context, next) {
        ...
        setTimeout(function () {
            ...
            _trigger(docma.Event.Navigate, [is404 ? null : routeInfo]);
