...
module.exports = (function () {
     ...
     *  @param {String} keyExt - File extension to be found in the keys, with
     *  the dot. e.g. `".js"`
     *  @param {String} [valExt] - File extension to be found in the values,
     *  with the dot.
     *
     *  @returns {Object}
     */
     ...
     *  @param {Object} appConfig - SPA configuration.
     *  @param {Object} paths - Paths of Docma-Web scripts or assets.
     ...
     *
     *  @param {String} [pathNames] - Only used if `appConfig.server` is set
     *  to `"github"`.
     *
     *  @returns {Promise}
     */
    DocmaTemplate.prototype.writeServerConfig = function (routes) {
        ...
        if ($this.appConfig.routing !== 'path') {
        ...
        } else if ($this.appConfig.server === 'github') {
